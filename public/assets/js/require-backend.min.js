    ...
    tableExport: function (options) {  
      ...
      if (defaults.type == 'csv' || defaults.type == 'txt') {  
        ...
        try {  
          ...
          var blob = new Blob(csvData.content.slice(0,1200), {type: "text/" + (defaults.type == 'csv' ? 'csv' : 'plain') + ";charset=utf-8"});  
       ...
       var rowIndex = 0;
        ...
        $(el).find('thead').first().find(defaults.theadSelector).each(function() {
          excel += "<tr>";
          myForEachVisibleCell(this, 'th,td', rowIndex,
                             function(cell, row, col) {
                               if (cell != null) {
                                 excel += "<td style='";
        ...
        $(el).find('tbody').first().find(defaults.tbodySelector).each(function() {
          excel += "<tr>";
          myForEachVisibleCell(this, 'td', rowIndex,
                             function(cell, row, col) {
                               if (cell != null) {
                                   excel += "<td style='mso-number-format:\"@\";";
                                 for( var styles in defaults.excelstyles ) {
                                   if( defaults.excelstyles.hasOwnProperty(styles) ) {
                                     excel += defaults.excelstyles[styles] + ": " + $(cell).css(defaults.excelstyles[styles]) + ";";
                                   }
      ...
      } else if (defaults.type == 'xls' || defaults.type == 'word' || defaults.type == 'doc') {  
        ...
        if (defaults.outputMode === 'base64')  
          return base64encode(docFile.toString());  
      ...
      function myForEachVisibleCell(tableRow, selector, rowIndex, cellcallback) {
      ...
      function rgb2array(rgb_string, default_result) {  
        var re = /^rgb(\d1,3),\s∗(\d1,3),\s∗(\d1,3)(\d1,3),\s∗(\d1,3),\s∗(\d1,3)$/;  
